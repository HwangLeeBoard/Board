...
public class BoardDTO implements Serializable {
	...
	*/
	...
	private int idx; // 글의 인덱스
	private int board_code; // 게시판 번호
	private int categorys; // 카테고리 번호
	...
	private String dateTime; // 글쓴 시간
	private String is_notice; // 공지사항
	private int likecnt; // 좋아요
	private int badcnt; // 싫어요
	private String is_comment; // 코멘트 허용
	private String is_reply; // 답글 허용
	private String is_private; // 공개허용
	private int seq; // repLoot
	private int levels; // repIndent
	private int step; // repStep
	private int fileCnt; // 파일의 수
	private int hits; // 조회수
	private int member_seq; // 맴버 테이블과 조인할때 쓰는 . . .
